...
async def nats_connect():
    ...
    try:
        ...
        async def message_handler(msg):
            ...
            socketio.emit("location", data, namespace="/monitor")
        ...
        while True:
            ...
            try:
                ...
                LOG.warning("NATS ping failed: %s", e)
                break
        ...
        LOG.error("Unexpected NATS error: %s", e)
        nats_connected = False
...
def on_location_update(data):
    ...
    socketio.emit("location", payload, namespace="/monitor")
